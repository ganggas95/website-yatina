...
export function ActivityGrid({
  activities,
  showFilters = true,
  emptyTitle = "Belum ada kegiatan pada kategori ini",
  emptyDescription = "Kegiatan pada kategori yang Anda pilih akan ditambahkan seiring berjalannya waktu. Silakan pilih kategori lain atau kembali di lain kesempatan.",
}: ActivityGridProps) {
